...
def generate_launch_description():
    ...
    file_subpath = 'description/3r_manipulator.urdf.xacro' # Replace with the file path of your custom xacro file for manipulator 2

    xacro_file = os.path.join(get_package_share_directory(pkg_name), file_subpath)
    robot_description_raw = xacro.process_file(xacro_file).toxml()

    # Configure the node for manipulator 2
    three_r_manipulator = Node(
    ...
    return LaunchDescription([three_r_manipulator])